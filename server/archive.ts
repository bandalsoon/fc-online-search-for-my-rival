...
export const ARCHIVE_VERSION = "ULTIMATE v4.5";
export const FRIENDLY_MATCH_TYPE = 40;
export const INCLUDED_FRIENDLY_MODES = ["클래식 1on1", "공식 친선"] as const;
...
const FRIENDLY_NAMES = new Set<string>(INCLUDED_FRIENDLY_MODES);
